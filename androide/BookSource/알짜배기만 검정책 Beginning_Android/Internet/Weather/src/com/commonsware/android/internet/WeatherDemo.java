...
public class WeatherDemo extends Activity {
	...
	private void updateForecast(Location loc) {
		...
		try {
			...
			Toast
				.makeText(this, "요청 실패: "+t.toString(), 4000)
				.show();
		}
	}
	...
	class Forecast {
		...
		Integer getTempCelcius() {
			return Integer.valueOf( (int) ( ( temp - 32 ) / 9.0 * 5 ) );
		}
