...
public class InflationDemo extends Activity {
	...
	static {
		...
		MESSAGES.put(R.id.close, "닫기 선택");
		MESSAGES.put(R.id.no_icon, "아이콘 없음 선택");
		MESSAGES.put(R.id.later, "첫번째 숨김 선택");
		MESSAGES.put(R.id.last, "두번째 숨김 선택");
		MESSAGES.put(R.id.non_ghost, "첫번째 하위 항목 선택");
		MESSAGES.put(R.id.ghost, "숨겨진 하위 항목 선택");
	};
