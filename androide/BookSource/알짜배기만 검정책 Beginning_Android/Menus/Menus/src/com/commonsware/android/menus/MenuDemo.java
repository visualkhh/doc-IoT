...
public class MenuDemo extends ListActivity {
	...
	private void populateMenu(Menu menu) {
		menu.add(Menu.NONE, ONE_ID, Menu.NONE, "1 픽셀");
		menu.add(Menu.NONE, TWO_ID, Menu.NONE, "2 픽셀");
		menu.add(Menu.NONE, EIGHT_ID, Menu.NONE, "8 픽셀");
		menu.add(Menu.NONE, SIXTEEN_ID, Menu.NONE, "16 픽셀");
		menu.add(Menu.NONE, TWENTY_FOUR_ID, Menu.NONE, "24 픽셀");
		menu.add(Menu.NONE, THIRTY_TWO_ID, Menu.NONE, "32 픽셀");
		menu.add(Menu.NONE, FORTY_ID, Menu.NONE, "40 픽셀");
	}
